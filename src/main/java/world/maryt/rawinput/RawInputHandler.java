...
public class RawInputHandler {
    ...
    public static void getMouse(String reason) {
        Thread getMouseThread = new Thread(new Runnable() {
			@Override
			public void run() {
    ...
    public static void toggleRawInput() {
        ...
        if (minecraft.mouseHelper instanceof RawMouseHelper) {
            minecraft.mouseHelper = new MouseHelper();
            minecraft.mouseHelper.grabMouseCursor();
            player.sendMessage(new TextComponentString("Toggled OFF"));
        } else {
            minecraft.mouseHelper = new RawMouseHelper();
            minecraft.mouseHelper.grabMouseCursor();
            player.sendMessage(new TextComponentString("Toggled ON"));
        }
